...
#' @param min vector of minimum axis limits c(x, y)
#' @param max vector of maximum axis limits c(x, y)
#' @param div Factor by which the minor tick interval is smaller than the major tick interval c(x,y)
#' @param x_axis Side on which to draw the x axis
#' @param y_axis Side on which to draw the y axis
